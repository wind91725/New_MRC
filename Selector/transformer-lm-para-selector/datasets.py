...
def msmarco(data_dir):
    train_queries, train_passages, train_targets = _msmarco(os.path.join(data_dir, 'train_processed_selector.txt'))
    dev_queries, dev_passages, dev_targets = _msmarco(os.path.join(data_dir, 'dev_processed_selector.txt'))
