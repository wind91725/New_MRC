...
CUDA_VISIBLE_DEVICES=1,2,3,0 python run_squad.py   --vocab_file $BERT_BASE_DIR/vocab.txt   --bert_config_file $BERT_BASE_DIR/bert_config.json  --do_train --do_predict  --do_lower_case   --train_file $SQUAD_DIR/dev-v1.1.json   --predict_file $SQUAD_DIR/dev-v1.1.json   --train_batch_size 32 --predict_batch_size 20   --encoder_learning_rate 3e-5 --decoder_learning_rate 3e-3  --num_train_epochs 2   --max_seq_length 384   --doc_stride 128   --output_dir ../debug_squad/ --half_dim --init_checkpoint $BERT_BASE_DIR/pytorch_model.bin --load_trained_model
